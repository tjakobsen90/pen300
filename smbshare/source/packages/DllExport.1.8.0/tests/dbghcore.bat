...
echo   %~n0 -cs -no-less-15 /t:Rebuild&goto i4
:i2
set "hd="&set /a he=0
:i5
...
set hl=!v!&call :i8 "selected vswhere version:" v&set hv=1&goto i7)else if [!hf!]==[-version] (echo 2.4.1.19080+57a01fe&goto i4)else if [!hf!]==[-priority] (set /a "he+=1" & call :jh ic[!he!] v
